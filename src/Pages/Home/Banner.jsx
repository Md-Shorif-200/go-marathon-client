    ...
    return (
      ...
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        ...
        <SwiperSlide>
                        ...
                        <BannerCnt title={'Run Beyond Limits'} description={'Join GoMarathon and experience the thrill of every step. Register, train, and compete—your journey starts here.'} banner_img={img_6}></BannerCnt>
